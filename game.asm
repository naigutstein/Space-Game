...
fighter_001 EECS205BITMAP <41, 45, 255,, offset fighter_001 + sizeof fighter_001>
	...
	ast1 SPRITE <OFFSET asteroid_001, 1, 1, 1,?>
	ast1rect SPRITERECT <OFFSET asteroid_001, ?,?,?,?>
	ast1_direction DWORD 0

	ast2 SPRITE <OFFSET asteroid_002, 1, 200, 2,?>
	ast2rect SPRITERECT <OFFSET asteroid_002, ?,?,?,?>
	ast2_direction DWORD 0

	ast3 SPRITE <OFFSET asteroid_000, 600, 1, 1, 2>
	ast3rect SPRITERECT <OFFSET asteroid_000, ?,?,?,?>
	ast3_direction DWORD 0

	ship SPRITE <OFFSET fighter_001, 200, 50, 1,?>
	shiprect SPRITERECT <OFFSET fighter_001,?,?,?,?>

	ship0 SPRITE <OFFSET fighter_000, 200, 50, 1,?>
	shiprect0 SPRITERECT <OFFSET fighter_000,?,?,?,?>

	nuke SPRITE <OFFSET nuke_001, ?, ?, 0>
	nuke2 SPRITE <OFFSET nuke_003, ?, ?, 0>
	nuke3 SPRITE <OFFSET nuke_005, ?, ?, 0>

	award SPRITE <OFFSET nuke_000, 500,100,0>
	awardrec SPRITERECT <OFFSET nuke_000, ?,?,?,?>

	youlose BYTE "Game Over", 0
	startover BYTE "To restart press Enter key", 0
	start BYTE "Press Enter key to start", 0
	youwin BYTE "You Win!", 0
	pausedd BYTE "GAME PAUSED",0
	outpausedd BYTE "press key P to continue game", 0
	gameInstructions BYTE "Game instructions:", 0
	one BYTE "1. Moving: Press the arrow keys to move your ship around the screen",0
	two BYTE "2. Jump: Click mouse buttons to jump out of the way of an asteroid",0
	three BYTE "3. Collisions: watch out not to hit the asteroids!",0
	four BYTE "4. Win: reach the green nuke to win",0
	five BYTE "5. Loose: if you are hit by an asteroid",0
	six BYTE "6. Pause: press key P to pause game",0
	seven BYTE "7. Sound effect: check out sound affect when you win game!",0
	eight BYTE "8. Scrolling background: all the starts moving in background behind you",0
	nine BYTE "9. Complex Explosion: when you loose the game your ship explodes gradually",0
	ten BYTE "10. Visual effects: as you move your ship its gas will turn on and off",0
...
GameInit PROC 
	mov ast1.xcenter, 1                                         ;;initializing starting points
	mov ast1.ycenter, 1
	mov ast2.xcenter, 1
	mov ast2.ycenter, 200
	mov ast3.xcenter, 600
	mov ast3.ycenter, 1
	mov ship.xcenter, 200
	mov ship.ycenter, 50
	mov ship0.xcenter, 200
	mov ship0.ycenter, 50
	mov starting, 0
	INVOKE DrawStr, OFFSET start, 200,120, 0ffh                 ;;starting page instructions
	INVOKE DrawStr, OFFSET gameInstructions, 10, 160, 0ffh
	INVOKE DrawStr, OFFSET one, 10, 180, 0ffh
	INVOKE DrawStr, OFFSET two, 10, 200, 0ffh
	INVOKE DrawStr, OFFSET three, 10, 220, 0ffh
	INVOKE DrawStr, OFFSET four, 10, 240, 0ffh
	INVOKE DrawStr, OFFSET five, 10, 260, 0ffh
	INVOKE DrawStr, OFFSET six, 10, 280, 0ffh
	INVOKE DrawStr, OFFSET seven, 10, 300, 0ffh
	INVOKE DrawStr, OFFSET eight, 10, 320, 0ffh
	INVOKE DrawStr, OFFSET nine, 10, 340, 0ffh
	INVOKE DrawStr, OFFSET ten, 10, 360, 0ffh
...
GamePlay PROC
	...
	cmp starting, 0
	jne gaming
	mov eax, KeyPress                                           ;;to start game press enter
	mov ebx, VK_RETURN
	cmp eax, ebx
	je gaming	
again:
	INVOKE GameInit                                             ;;otherwise stay on the homepage
	jmp started
gaming: 	
	mov starting, 1
...
started: 
	...
	INVOKE DrawStarField, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12      ;;clear screen

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;move the stars in background;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	cmp s11, 640
	jl plus11
	mov s11, 1
check10:
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; SHIP BOUNDS  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	mov eax, 41
	sar eax, 1            
	mov ebx, ship0.xcenter
	sub ebx, eax                
	mov shiprect0.dwLeft, ebx                                         ;;finding out ship left

	mov ecx, ship0.xcenter
	add ecx, eax
	mov shiprect0.dwRight, ecx                                        ;;finding out ship right
	...
	mov eax, 45
	sar eax, 1
	mov ebx, ship0.ycenter
	sub ebx, eax
	mov shiprect0.dwTop, ebx                                           ;;finding out ship top

	mov ecx, ship0.ycenter
	add ecx, eax
	mov shiprect0.dwBottom, ecx                                         ;;finding out ship bottom
...
pause_press:
	mov eax, KeyPress                                        ;;P key pauses the ship    
	mov ecx, VK_P
	cmp ecx, eax
	jne pause_past
	cmp paused, 1
...
down_press:
	mov ebx, VK_DOWN                                             ;;down key moves ship downwards
	cmp ebx, eax
	jne up_press
	inc ship0.ycenter
	jmp draw_moving_ship

up_press:                                                        ;;up key moves ship upward
	mov ecx, VK_UP
	cmp ecx, eax
	jne right_press
	dec ship0.ycenter
...
right_press:                                                      ;;right key moves ship right
	mov ecx, VK_RIGHT 
	cmp ecx, eax
	jne left_press
	inc ship0.xcenter
...
left_press:                                                       ;;left key moves ship left
	mov ecx, VK_LEFT
	cmp ecx, eax
	jne mouse_click
	dec ship0.xcenter
...
mouse_click:
	...
	mov ebx, 0002h                                                ;;if right being clicked jump to right
	cmp ebx, eax
	je add_x_coor
	
	mov ecx, 0001h                                                ;;if left being clicked jump to left
	cmp ecx, eax
	je sub_x_coor   

add_x_coor:
	add ship0.xcenter, 10
	jmp draw_moving_ship

sub_x_coor:
	sub ship0.xcenter, 10
	jmp draw_moving_ship

draw_ship:
	INVOKE BasicBlit, ship0.btmp, ship0.xcenter, ship0.ycenter
	jmp touching

draw_moving_ship:
   INVOKE BasicBlit, ship.btmp, ship0.xcenter, ship0.ycenter
   
   jmp touching


asteroids:
	INVOKE BasicBlit, award.btmp, award.xcenter, award.ycenter
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ASTEROID 1 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

	mov ebx, ast1.xcenter
	mov ecx, ast1.vel
	jmp ast_condition

minus_position:                                                 ;; put asteroid back in bounds 
	INVOKE BasicBlit, ast1.btmp, ebx, ebx                        ;;draw asteroid
	dec ast1.xcenter
	mov ast1_direction, 1
	jmp peace0

plus_position:
	INVOKE BasicBlit, ast1.btmp, ebx, ebx                         ;;draw asteroid	
	inc ast1.xcenter
	mov ast1_direction, 0
	jmp peace0

ast_condition:	                                                  ;;check bounds of asteroid
	cmp ebx, 0
	jle plus_position
	cmp ebx, 480
	jge minus_position
	cmp ast1_direction, 0
	je plus_position
	cmp ast1_direction, 1
	je minus_position

peace0:
	mov eax, ast1.xcenter
	mov ast1.ycenter, eax                                         ;;save new ast1 position

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ASTEROID 2 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	xor ebx, ebx
	xor ecx, ecx
	mov ecx, ast2.vel
	mov ebx, ast2.xcenter                                                ;;ebx = x coordinate
	jmp ast2_condition

minus_x:
	INVOKE BasicBlit, ast2.btmp, ast2.xcenter, 200                 ;;draw asteroid
	sub ebx, ecx                                                ;;move negative x direction
	mov ast2_direction, 1
	jmp peace
plus_x: 
	INVOKE BasicBlit, ast2.btmp, ast2.xcenter, 200                  ;;draw asteroid
	add ebx, ecx                                                 ;; move positive x direction
	mov ast2_direction, 0
	jmp peace

ast2_condition:
	cmp ebx, 640                                                  ;;check bounds of asteroids
	jge minus_x
	cmp ebx, 0
	jle plus_x
	cmp ast2_direction, 1                                         ;;check direction of motion of asteroid
	je minus_x
	cmp ast2_direction, 0
	je plus_x

peace:
	mov ast2.xcenter, ebx                                        ;;save ast2 position
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ASTEROID 3 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov ecx, ast3.vel
	mov eax, ast3.acc
	mov ebx, ast3.ycenter                                            ;;ebx = y coordinate
	jmp ast3_condition

minus_y:
	INVOKE BasicBlit, ast3.btmp, 600, ebx                         ;;draw asteroid
	sub ebx, ecx                                                  ;;move negative y direction
	mov ast3_direction, 1
	jmp peace2
plus_y: 
	INVOKE BasicBlit, ast3.btmp, 600, ebx                         ;;draw asteroid
	add ebx, ecx                                                  ;; move positive y direction
	mov ast3_direction, 0
	jmp peace2

ast3_condition:
	cmp ebx, 480                                                  ;;check bounds of asteroids
	jge minus_y
	cmp ebx, 0
	jle plus_y
	cmp ast3_direction, 1                                         ;;check direction of motion of asteroid
	je minus_y
	cmp ast3_direction, 0
	je plus_y

peace2:
	mov ast3.ycenter, ebx                                          ;;save ast3 position
	jmp peace3
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AWARD ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;	
	mov eax, 8
	sar eax, 1
	mov ebx, award.xcenter
	sub ebx, eax
	mov awardrec.dwLeft, ebx                                        ;;sets award nuke left

	mov ecx, award.xcenter
	add eax, ecx
	mov awardrec.dwRight, ecx                                       ;;sets award nuke right 
	...
	mov eax, 9
	sar eax, 1
	mov ebx, award.ycenter
	sub ebx, eax
	mov awardrec.dwTop, ebx                                         ;;set award nuke top

	mov ecx, award.ycenter
	add ecx, eax
	mov awardrec.dwBottom, ecx                                       ;;set award nuke bottom
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AST1 HITTING CHECK;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov ebx, ast1.xcenter
	sub ebx, eax                
	mov ast1rect.dwLeft, ebx                                         ;;finding out ast1 left

	mov ecx, ast1.xcenter
	add ecx, eax
	mov ast1rect.dwRight, ecx                                        ;;finding out ast1 right
	...
	mov eax, 32
	sar eax, 1
	mov ebx, ast1.ycenter
	sub ebx, eax
	mov ast1rect.dwTop, ebx                                           ;;finding out ast1 top
	
	mov ecx, ast1.ycenter
	add ecx, eax
	mov ast1rect.dwBottom, ecx                                        ;;finding out ast1 bottom
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AST2 HITTING CHECK;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov eax, 13
	sar eax, 1            
	mov ebx, ast2.xcenter
	sub ebx, eax                
	mov ast2rect.dwLeft, ebx                                         ;;finding out ast2 left

	mov ecx, ast2.xcenter
	add ecx, eax
	mov ast2rect.dwRight, ecx                                        ;;finding out ast2 right
	...
	mov eax, 14
	sar eax, 1
	mov ebx, ast2.ycenter
	sub ebx, eax
	mov ast2rect.dwTop, ebx                                           ;;finding out ast2 top

	mov ecx, ast2.ycenter
	add ecx, eax
	mov ast2rect.dwBottom, ecx                                        ;;finding out ast2 bottom
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AST3 HITTING CHECK;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov eax, 56
	sar eax, 1            
	mov ebx, ast3.xcenter
	sub ebx, eax                
	mov ast3rect.dwLeft, ebx                                         ;;finding out ast3 left

	mov ecx, ast3.xcenter
	add ecx, eax
	mov ast3rect.dwRight, ecx                                        ;;finding out ast3 right
	...
	mov eax, 53
	sar eax, 1
	mov ebx, ast3.ycenter
	sub ebx, eax
	mov ast3rect.dwTop, ebx                                           ;;finding out ast3 top

	mov ecx, ast3.ycenter
	add ecx, eax
	mov ast3rect.dwBottom, ecx                                        ;;finding out ast3 bottom


	mov ebx, shiprect0.dwLeft
	mov l1, ebx                                               ;; ship left--> l1

	xor ebx, ebx
	mov ebx, shiprect0.dwRight                     
	mov r1, ebx                                               ;; ship right--> r1

	xor ebx, ebx
	mov ebx, shiprect0.dwTop
	mov t1, ebx                                               ;; ship top --> t1

	xor ebx, ebx
	mov ebx, shiprect0.dwBottom
	mov b1, ebx                                               ;; ship bottom --> b1
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; AWARD CHECK ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov eax, awardrec.dwLeft
	mov ebx, awardrec.dwRight
	mov ecx, awardrec.dwTop
	mov edx, awardrec.dwBottom
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;ASTEROID ONE CHECK ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov eax, ast1rect.dwLeft                    ;; ship left--> eax
	mov ebx, ast1rect.dwRight                   ;; ship right--> ebx
	mov ecx, ast1rect.dwTop                     ;; ship top --> ecx
	mov edx, ast1rect.dwBottom                  ;; ship bottom --> edx
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;ASTEROID TWO CHECK ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov eax, ast2rect.dwLeft                    ;; ship left--> eax
	mov ebx, ast2rect.dwRight                   ;; ship right--> ebx
	mov ecx, ast2rect.dwTop                     ;; ship top --> ecx
	mov edx, ast2rect.dwBottom                  ;; ship bottom --> edx
...
not_overlapping2:
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;ASTEROID THREE CHECK ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	xor eax, eax
	xor ebx, ebx
	xor ecx, ecx
	xor edx, edx

	mov eax, ast3rect.dwLeft                    ;; ship left--> eax
	mov ebx, ast3rect.dwRight                   ;; ship right--> ebx
	mov ecx, ast3rect.dwTop                     ;; ship top --> ecx
	mov edx, ast3rect.dwBottom                  ;; ship bottom --> edx
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;winning?;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	jmp overlapping
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;overlapping vs not overlapping conditions;;;;;;;;;;;;;;;;;;;;;;;;;
winning:
	INVOKE DrawStr, OFFSET youwin, 270,200,0ffh
	INVOKE PlaySound, offset SndPath, 0, SND_FILENAME
;	INVOKE DrawStr, OFFSET startover, 210, 220, 0ffh              ;;restart
	mov eax, KeyPress
	mov ebx, VK_RETURN
	cmp eax, ebx
	jne rtime
...
overlapping:
	mov edi, ship0.xcenter
	mov esi, ship0.ycenter
	INVOKE BasicBlit, nuke.btmp, edi, esi                         ;;draw the nuke
	inc explode
	cmp explode, 5
	jl ex2
	INVOKE BasicBlit, nuke2.btmp, edi, esi                         ;;draw outer nuke
	inc explode2
	cmp explode2, 5
	jl ex2
	INVOKE BasicBlit, nuke3.btmp, edi, esi                         ;;draw outside nuke
	
ex2:
	INVOKE DrawStr, OFFSET youlose, 270,200, 0ffh                 ;;say you loose
	INVOKE DrawStr, OFFSET startover, 210, 220, 0ffh              ;;say how to restart
	

	mov eax, KeyPress                                             ;;press enter to restart
	mov ebx, VK_RETURN
	cmp eax, ebx
	jne rtime
	INVOKE GameInit
...
peace4:
	INVOKE DrawStr, OFFSET pausedd, 270,200, 0ffh                
	INVOKE DrawStr, OFFSET outpausedd, 210, 220, 0ffh              ;;paused
peace3:
	INVOKE BasicBlit, ship0.btmp, ship0.xcenter, ship0.ycenter
	INVOKE BasicBlit, ast1.btmp, ast1.xcenter, ast1.ycenter
	INVOKE BasicBlit, ast2.btmp, ast2.xcenter, ast2.ycenter
	INVOKE BasicBlit, ast3.btmp, ast3.xcenter, ast3.ycenter
	INVOKE BasicBlit, award.btmp, award.xcenter, award.ycenter
	ret         ;; Do not delete this line!!!
GamePlay ENDP
